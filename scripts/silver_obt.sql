...
AS
    ...
    SELECT
            ...
            map_cities.city as city, map_cities.state, map_cities.region, map_cities.updated_at
    ...
    FROM
        ...
        STREAM (uberdataengineering.bronze.stg_rides)
        ...
        WATERMARK booking_timestamp DELAY OF INTERVAL 3 MINUTES stg_rides
            ...
            LEFT JOIN
                ...
                uberdataengineering.bronze.map_vehicle_makes map_vehicle_makes
            ...
            LEFT JOIN
                ...
                uberdataengineering.bronze.map_vehicle_types map_vehicle_types
            ...
            LEFT JOIN
                ...
                uberdataengineering.bronze.map_ride_statuses map_ride_statuses

            ON 

                stg_rides.ride_status_id = map_ride_statuses.ride_status_id

        

            LEFT JOIN

                uberdataengineering.bronze.map_payment_methods map_payment_methods

            ON 

                stg_rides.payment_method_id = map_payment_methods.payment_method_id

        

            LEFT JOIN

                uberdataengineering.bronze.map_cities map_cities
            ...
            LEFT JOIN
                ...
                uberdataengineering.bronze.map_cancellation_reasons map_cancellation_reasons

            ON 

                stg_rides.cancellation_reason_id = map_cancellation_reasons.cancellation_reason_id